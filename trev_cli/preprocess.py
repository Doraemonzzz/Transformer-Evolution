...
from trev import options, tasks, utils
from trev.binarizer import Binarizer
from trev.data import indexed_dataset
...
logger = logging.getLogger("trev_cli.preprocess")
