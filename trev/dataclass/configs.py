...
from trev.dataclass.constants import (
...
@dataclass
class TrevDataclass:
    """trev base dataclass that supported fetching attributes and metas"""
...
@dataclass
class CommonConfig(TrevDataclass):
...
@dataclass
class DistributedTrainingConfig(TrevDataclass):
...
@dataclass
class DatasetConfig(TrevDataclass):
...
@dataclass
class OptimizationConfig(TrevDataclass):
    max_epoch: int = field(
...
@dataclass
class CheckpointConfig(TrevDataclass):
    save_dir: str = field(
...
@dataclass
class TrevBMUFConfig(TrevDataclass):
...
@dataclass
class GenerationConfig(TrevDataclass):
    beam: int = field(
...
@dataclass
class CommonEvalConfig(TrevDataclass):
    ...
    post_process: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                "Valid options can be found in trev.data.utils.post_process."
            ),
...
@dataclass
class EvalLMConfig(TrevDataclass):
...
@dataclass
class InteractiveConfig(TrevDataclass):
...
@dataclass
class TrevConfig(TrevDataclass):
    ...
    bmuf: TrevBMUFConfig = TrevBMUFConfig()
