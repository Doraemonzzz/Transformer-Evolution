...
from trev.utils import buffered_arange
...
@dataclass
class Wav2VecConfig(TrevDataclass):
...
class Wav2VecModel(BaseTrevModel):
    @classmethod
    def build_model(cls, cfg: Wav2VecConfig, task: TrevTask):
