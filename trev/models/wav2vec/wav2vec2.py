...
from trev.data.data_utils import compute_mask_indices
from trev.dataclass import ChoiceEnum, TrevDataclass
from trev.models import BaseTrevModel, register_model
...
from trev.utils import buffered_arange, index_put, is_xla_tensor
...
@dataclass
class Wav2Vec2Config(TrevDataclass):
...
class Wav2Vec2Model(BaseTrevModel):
