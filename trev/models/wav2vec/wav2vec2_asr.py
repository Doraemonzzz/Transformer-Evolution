...
from trev.models.wav2vec.wav2vec2 import MASKING_DISTRIBUTION_CHOICES
from trev.modules import LayerNorm, PositionalEmbedding, TransformerDecoderLayer


@dataclass
class Wav2Vec2AsrConfig(TrevDataclass):
    w2v_path: str = field(
...
class Wav2VecCtc(BaseTrevModel):
    def __init__(self, cfg: Wav2Vec2CtcConfig, w2v_encoder: BaseTrevModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Wav2Vec2CtcConfig, task: TrevTask):
...
class Wav2Vec2Seq2SeqModel(TrevEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)

    @classmethod
    def build_model(cls, cfg: Wav2Vec2Seq2SeqConfig, task: TrevTask):
        """Build a new model instance."""
...
class Wav2VecEncoder(TrevEncoder):
