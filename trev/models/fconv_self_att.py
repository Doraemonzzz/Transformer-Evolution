...
class FConvModelSelfAtt(TrevEncoderDecoderModel):
    @classmethod
    def hub_models(cls):
        return {
            "conv.stories.pretrained": {
                "path": "https://dl.fbaipublicfiles.com/trev/models/stories_checkpoint.tar.gz",
            ...
            "data.stories": "https://dl.fbaipublicfiles.com/trev/data/stories_test.tar.bz2",
        }
...
class FConvDecoder(TrevDecoder):
