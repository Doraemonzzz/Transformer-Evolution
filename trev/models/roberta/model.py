...
class RobertaModel(TrevEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
            "roberta.base": "http://dl.fbaipublicfiles.com/trev/models/roberta.base.tar.gz",
            "roberta.large": "http://dl.fbaipublicfiles.com/trev/models/roberta.large.tar.gz",
            "roberta.large.mnli": "http://dl.fbaipublicfiles.com/trev/models/roberta.large.mnli.tar.gz",
            "roberta.large.wsc": "http://dl.fbaipublicfiles.com/trev/models/roberta.large.wsc.tar.gz",
        }
...
class RobertaEncoder(TrevEncoder):
    """RoBERTa encoder."""
