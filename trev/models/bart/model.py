...
from trev.models.transformer import TransformerModel
...
class BARTModel(TransformerModel):
    ...
    def hub_models(cls):
        return {
            "bart.base": "http://dl.fbaipublicfiles.com/trev/models/bart.base.tar.gz",
            "bart.large": "http://dl.fbaipublicfiles.com/trev/models/bart.large.tar.gz",
            "bart.large.mnli": "http://dl.fbaipublicfiles.com/trev/models/bart.large.mnli.tar.gz",
            "bart.large.cnn": "http://dl.fbaipublicfiles.com/trev/models/bart.large.cnn.tar.gz",
            "bart.large.xsum": "http://dl.fbaipublicfiles.com/trev/models/bart.large.xsum.tar.gz",
        }
