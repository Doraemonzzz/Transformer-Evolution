...
from ..xformer import RFADecoder

@register_model("rfa", dataclass=TransformerLanguageModelConfig)
...
@register_model_architecture("rfa", "rfa_64")
def rfa_64(args):
    base_lm_architecture(args)
    args.proj_dim = 64
    
@register_model_architecture("rfa", "rfa_128")
def rfa_128(args):
    base_lm_architecture(args)
    args.proj_dim = 128