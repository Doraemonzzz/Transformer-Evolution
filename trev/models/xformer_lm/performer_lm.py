...
from ..xformer import PerformerDecoder

@register_model("performer", dataclass=TransformerLanguageModelConfig)
...
@register_model_architecture("performer", "performer_64")
def performer_64(args):
    base_lm_architecture(args)
    args.proj_dim = 64
    
@register_model_architecture("performer", "performer_128")
def performer_128(args):
    base_lm_architecture(args)
    args.proj_dim = 128