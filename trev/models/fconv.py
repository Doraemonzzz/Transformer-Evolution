...
class FConvModel(TrevEncoderDecoderModel):
    """
    ...
    def hub_models(cls):
        ...
        return {
            "conv.wmt14.en-fr": moses_subword(
                "https://dl.fbaipublicfiles.com/trev/models/wmt14.v2.en-fr.fconv-py.tar.bz2"
            ),
            "conv.wmt14.en-de": moses_subword(
                "https://dl.fbaipublicfiles.com/trev/models/wmt14.en-de.fconv-py.tar.bz2"
            ),
            "conv.wmt17.en-de": moses_subword(
                "https://dl.fbaipublicfiles.com/trev/models/wmt17.v2.en-de.fconv-py.tar.bz2"
            ),
        }
...
class FConvEncoder(TrevEncoder):
    """
...
class FConvDecoder(TrevIncrementalDecoder):
...
def ConvTBC(in_channels, out_channels, kernel_size, dropout=0.0, **kwargs):
    ...
    from trev.modules import ConvTBC
