...
from trev.modules import AdaptiveSoftmax, TrevDropout
...
@register_model("lstm")
class LSTMModel(TrevEncoderDecoderModel):
...
class LSTMEncoder(TrevEncoder):
    ...
    def __init__(
        ...
        self.dropout_in_module = TrevDropout(
            dropout_in, module_name=self.__class__.__name__
        )
        self.dropout_out_module = TrevDropout(
...
class LSTMDecoder(TrevIncrementalDecoder):
    """LSTM decoder."""
