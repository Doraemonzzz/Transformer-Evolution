...
from trev.modules import CosformerEncoderLayer, CosformerDecoderLayer
...
##### Cosformer encoder + Softmaxdecoder
class CosformerSoftmaxDecoder(TrevIncrementalDecoder):
    def __init__(
        self,
        args,
        dictionary,
        ...
        for _ in range(args.decoder_layers):
            ...
            if _ < args.cosformer_layers:
                arr.append(self.build_cosformer_decoder_layer(args, no_encoder_attn))
            else:
    ...
    def build_cosformer_decoder_layer(self, args, no_encoder_attn=False):
        layer = CosformerDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
...
@register_model("encoder_cosformer")
...
@register_model_architecture("cosformer", "cosformer_wmt_en_de_small_single_head")
def cosformer_wmt_en_de_small_single_head(args):
...
@register_model_architecture("cosformer", "cosformer_multi_wmt_en_de_small_multi_head")
def cosformer_multi_wmt_en_de_small_multi_head(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
    args.causal = False
...
##### encoder: softmax
@register_model_architecture("decoder_cosformer", "decoder_cosformer_multi_wmt_en_de_small")
def decoder_cosformer_multi_wmt_en_de_small(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
    args.causal = False

@register_model_architecture("decoder_cosformer", "decoder_cosformer_wmt_en_de_small_single_head")
def decoder_cosformer_wmt_en_de_small_single_head(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
    args.causal = False
...
##### encoder cosformer + decoder softmax
@register_model_architecture("encoder_cosformer", "encoder_cosformer_wmt_en_de_small")
def encoder_cosformer_wmt_en_de_small(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
    args.causal = False
...
##### mutli: encoder cosformer + decoder softmax
@register_model_architecture("encoder_cosformer", "encoder_cosformer_multi_wmt_en_de_small_multi_head")
def encoder_cosformer_multi_wmt_en_de_small_multi_head(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
    args.causal = False

##### encoder cosformer + outproj + decoder softmax
@register_model_architecture("encoder_cosformer", "encoder_cosformer_wmt_en_de_small_without_single_head")
def encoder_cosformer_wmt_en_de_small_without_single_head(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
