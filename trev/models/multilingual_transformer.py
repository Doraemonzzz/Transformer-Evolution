...
class MultilingualTransformerModel(TrevMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        from trev.tasks.multilingual_translation import MultilingualTranslationTask
        ...
        if args.share_all_embeddings:
            ...
            shared_encoder_embed_tokens = TrevMultiModel.build_shared_embeddings(
                dicts=task.dicts,
                langs=task.langs,
            ...
            if args.share_decoder_embeddings:
                shared_decoder_embed_tokens = TrevMultiModel.build_shared_embeddings(
                    dicts=task.dicts,
                    langs=tgt_langs,
