...
from trev.data.data_utils import lengths_to_padding_mask
from trev import checkpoint_utils, utils
...
from trev.models.transformer import Embedding, TransformerDecoder
from trev.modules import LayerNorm, PositionalEmbedding, TransformerEncoderLayer
...
class ConvTransformerModel(TrevEncoderDecoderModel):
    """
...
class ConvTransformerEncoder(TrevEncoder):
