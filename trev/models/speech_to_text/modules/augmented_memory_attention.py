...
from trev.models import TrevEncoder
from trev.models.speech_to_text import (
    ConvTransformerEncoder,
)
from trev.models.speech_to_text.utils import attention_suppression
from trev.models.speech_to_text.utils import (
    lengths_to_encoder_padding_mask,
    segments_to_sequence,
    sequence_to_segments,
)
from trev.modules import MultiheadAttention, TransformerEncoderLayer
...
#   SequenceEncoder
# ------------------------------------------------------------------------------
class SequenceEncoder(TrevEncoder):
    """
