...
class _FP16OptimizerMixin(object):
    ...
    def backward(self, loss):
        ...
        Compared to :func:`trev.optim.TrevOptimizer.backward`, this
...
class FP16Optimizer(_FP16OptimizerMixin, optim.TrevOptimizer):
    """
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            cfg (omegaconf.DictConfig): trev args
...
class MemoryEfficientFP16Optimizer(
    _MemoryEfficientFP16OptimizerMixin, optim.TrevOptimizer
):
    """
    Wrap an *optimizer* to support FP16 (mixed precision) training.

    Compared to :class:`trev.optim.FP16Optimizer`, this version does not
    ...
    *supports_memory_efficient_fp16* property.
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            args (argparse.Namespace): trev args
            params (iterable): iterable of parameters to optimize
        """
