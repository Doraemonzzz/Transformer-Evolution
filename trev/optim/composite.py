...
from trev.optim import TrevOptimizer, register_optimizer, _build_optimizer
from trev.optim.lr_scheduler import TrevLRScheduler, build_lr_scheduler
...
@dataclass
class OptimizerAndSchedulerConfig(TrevDataclass):
    optimizer: Any = None
...
@dataclass
class CompositeOptimizerConfig(TrevDataclass):
...
class TrevCompositeOptimizer(TrevOptimizer):

    optimizers: Dict[str, TrevOptimizer] = {}
    lr_schedulers: Dict[str, TrevLRScheduler] = {}
    lr_scheduler: TrevLRScheduler = None
...
class CompositeOptimizer(torch.optim.Optimizer):
    def __init__(self, optimizers: Dict[str, TrevOptimizer]):
...
class CompositeLRScheduler(TrevLRScheduler):
