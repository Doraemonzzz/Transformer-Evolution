...
@dataclass
class TrevCPUAdamConfig(TrevDataclass):
...
@register_optimizer("cpu_adam", dataclass=TrevCPUAdamConfig)
class TrevCPUAdam(TrevOptimizer):
    """Adam optimizer for trev, optimized for CPU tensors.
