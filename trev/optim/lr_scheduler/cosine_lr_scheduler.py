...
@dataclass
class CosineLRScheduleConfig(TrevDataclass):
...
class CosineLRSchedule(TrevLRScheduler):
    ...
    def __init__(self, cfg: CosineLRScheduleConfig, trev_optimizer):
        super().__init__(cfg, trev_optimizer)
