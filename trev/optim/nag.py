...
from . import TrevOptimizer, register_optimizer


@dataclass
class TrevNAGConfig(TrevDataclass):
...
@register_optimizer("nag", dataclass=TrevNAGConfig)
class TrevNAG(TrevOptimizer):
