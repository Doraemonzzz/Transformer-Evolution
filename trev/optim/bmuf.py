...
from trev.dataclass.configs import TrevBMUFConfig
from trev.dataclass.utils import gen_parser_from_dataclass
from trev.optim.trev_optimizer import TrevOptimizer


class TrevBMUF(TrevOptimizer):
    """
    ...
    def __init__(self, cfg: TrevBMUFConfig, optimizer):
        super().__init__(cfg)
    ...
    def add_args(parser):
        ...
        gen_parser_from_dataclass(parser, TrevBMUFConfig())
