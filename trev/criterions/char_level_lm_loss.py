...
# from https://github.com/NVIDIA/transformer-ls/blob/master/autoregressive/model_lib/loss.py
...
from trev.criterions import register_criterion
from trev.criterions.cross_entropy import CrossEntropyCriterion
from trev.dataclass import TrevDataclass
from omegaconf import II


@dataclass
class AdaptiveSpanCriterionConfig(TrevDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")


@register_criterion("char_level_lm_loss", dataclass=AdaptiveSpanCriterionConfig)
class CharLevelLmLoss(CrossEntropyCriterion):
