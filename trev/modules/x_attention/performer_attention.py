...
class PerformerAttention(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.index = index
        self.attn = attn.PerformerAttention(embed_dim, num_heads, proj_dim=proj_dim, causal=causal, dropout=dropout)
        # init
        ...
        logging.info(f"proj_dim {proj_dim}")
    ...
    def forward(
        ...
        x = x.transpose(0, 1)
        y = y.transpose(0, 1)
        attn_output = self.attn(x, y, attn_mask)
        # B, N, E -> N, B, E
