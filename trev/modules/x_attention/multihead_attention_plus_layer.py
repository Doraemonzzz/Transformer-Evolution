...
class TransformerEncoderLayerPlus(nn.Module):
    """Encoder layer block.
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def build_self_attention(self, embed_dim, args):
        return MultiheadAttentionPlus(
            ...
            # rpe_vanilla
            use_rpe_vanilla=getattr(args, "use_rpe_vanilla", False),
        )
...
class TransformerDecoderLayerPlus(nn.Module):
    """Decoder layer block.
