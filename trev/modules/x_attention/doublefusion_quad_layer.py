...
from trev.modules import LayerNorm, TransformerEncoderLayer, TransformerDecoderLayer
...
from trev.modules import TokenShift

########################################################################
# DoubleFusionQuad
class DoubleFusionQuadEncoderLayer(nn.Module):
    ...
    def build_self_attention(self, embed_dim, args):
        return DoubleFusionQuad(
            ...
            forward_type=getattr(args, "forward_type", "default"),
        )
...
class DoubleFusionQuadDecoderLayer(nn.Module):
    """Decoder layer block.
