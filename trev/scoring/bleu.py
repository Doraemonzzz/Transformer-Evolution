...
from trev.scoring import BaseScorer, register_scorer
from trev.scoring.tokenizer import EvaluationTokenizer
...
@dataclass
class SacrebleuConfig(TrevDataclass):
...
@dataclass
class BleuConfig(TrevDataclass):
