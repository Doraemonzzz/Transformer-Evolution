...
from trev.binarizer import safe_readline
from trev.data import data_utils
from trev.file_io import PathManager
from trev.tokenizer import tokenize_line

from trev.data.encoders.gpt2_bpe import get_encoder
import json
from trev import file_utils
...
class DictionaryGPT2:
    ...
    def bos(self):
        ...
        return self.indices[self.bos_word]

    def pad(self):
        """Helper to get index of pad symbol"""
        return self.indices[self.pad_word]

    def eos(self):
        """Helper to get index of end-of-sentence symbol"""
        return self.indices[self.eos_word]
    ...
    def add_from_file(self, f):
        ...
        if isinstance(f, str):
            try:
                ...
                print('wget -O encoder.json "https://dl.fbaipublicfiles.com/trev/gpt2_bpe/encoder.json" \
                      wget -O vocab.bpe "https://dl.fbaipublicfiles.com/trev/gpt2_bpe/vocab.gpe"')
            try:
        ...
        for key in encoder.keys():
            self.add_symbol(key, n=int(encoder[key]), overwrite=False)
    ...
    def encode_line(
        ...
        ids = torch.IntTensor(self.bpe.encode(line))
        return ids
...
class TruncatedDictionaryGPT2(object):
