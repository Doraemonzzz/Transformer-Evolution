...
import numpy as np
import torch
from trev.dataclass.constants import DATASET_IMPL_CHOICES
from trev.data.fasta_dataset import FastaDataset
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from trev.data.fasta_dataset import EncodedFastaDataset
...
class IndexedDataset(TrevDataset):
...
class IndexedRawTextDataset(TrevDataset):
