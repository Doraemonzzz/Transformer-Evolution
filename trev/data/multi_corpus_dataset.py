...
from . import TrevDataset

logger = logging.getLogger(__name__)


class MultiCorpusDataset(TrevDataset):
    """
    Stores multiple instances of TrevDataset together. Requires each instance
    ...
    Args:
        datasets: a OrderedDict of TrevDataset instances.
    ...
    def batch_by_size(
        ...
        # Assume shuffling is handled in trev/data/iterators.py
        return batches
