...
class TransformEosDataset(TrevDataset):
    """A :class:`~trev.data.TrevDataset` wrapper that appends/prepends/strips EOS.

    Note that the transformation is applied in :func:`collater`.

    Args:
        dataset (~trev.data.TrevDataset): dataset to wrap
    ...
    def __init__(
        ...
        if not isinstance(dataset, TrevDataset):
            raise ValueError("dataset must be an instance of TrevDataset")
