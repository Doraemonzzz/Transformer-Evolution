...
class MultiCorpusSampledDataset(TrevDataset):
    """
    Stores multiple instances of TrevDataset together and in every iteration
    ...
    Args:
        datasets: an OrderedDict of TrevDataset instances.
