...
import numpy as np
import torch
from trev.data import Dictionary, TrevDataset, data_utils
from trev.data.concat_dataset import ConcatDataset
from trev.data.legacy.block_pair_dataset import BlockPairDataset
from trev.data.token_block_dataset import TokenBlockDataset


class MaskedLMDataset(TrevDataset):
    """
