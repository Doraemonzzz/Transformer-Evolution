...
from . import TrevDataset, LanguagePairDataset

logger = logging.getLogger(__name__)


class RoundRobinZipDatasets(TrevDataset):
    """Zip multiple :class:`~trev.data.TrevDataset` instances together.

    Shorter datasets are repeated in a round-robin fashion to match the length
    of the longest one.

    Args:
        datasets (Dict[~trev.data.TrevDataset]): a dictionary of
            :class:`~trev.data.TrevDataset` instances.
