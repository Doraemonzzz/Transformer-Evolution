...
class TransformEosLangPairDataset(TrevDataset):
    """A :class:`~trev.data.TrevDataset` wrapper that transform bos on
    collated samples of language pair dataset.

    Note that the transformation is applied in :func:`collater`.

    Args:
        dataset (~trev.data.TrevDataset): dataset that collates sample into
