...
import numpy as np
import torch
from trev.data import TrevDataset, plasma_utils
from trev.data.indexed_dataset import best_fitting_int_dtype
from typing import Tuple


class TokenBlockDatasetGPT2(TrevDataset):
    ...
    def _build_slice_indices(
        ...
        try:
            from trev.data.token_block_utils_fast import (
    ...
    def __getitem__(self, index):
        ...
        if self.include_targets:
            ...
            source = buffer[s:e]
            return source, item[1:], past_target
