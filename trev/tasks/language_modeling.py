...
from trev.data.shorten_dataset import maybe_shorten_dataset
from trev.dataclass import ChoiceEnum, TrevDataclass
from trev.tasks import LegacyTrevTask, register_task
...
@dataclass
class LanguageModelingConfig(TrevDataclass):
...
class LanguageModelingTask(LegacyTrevTask):
    """
    Train a language model.

    Args:
        dictionary (~trev.data.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~trev.data.Dictionary): the dictionary for the
    ...
    .. note::
        ...
        The language modeling task is compatible with :mod:`trev-train`,
        :mod:`trev-generate`, :mod:`trev-interactive` and
        :mod:`trev-eval-lm`.
    ...
    .. argparse::
        :ref: trev.tasks.language_modeling_parser
        :prog:
    """
    ...
    def source_dictionary(self):
        """Return the :class:`~trev.data.Dictionary` for the language
        model."""
