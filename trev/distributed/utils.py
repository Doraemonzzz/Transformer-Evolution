...
from trev.dataclass.configs import DistributedTrainingConfig, TrevConfig
...
def distributed_init(cfg: TrevConfig):
    ...
    if cfg.common.model_parallel_size > 1:
        try:
            from trev.model_parallel.megatron.mpu import (
...
def distributed_main(i, main, cfg: TrevConfig, kwargs):
...
def call_main(cfg: TrevConfig, main, **kwargs):
...
def get_data_parallel_group():
    ...
    global _USE_MEGATRON
    if _USE_MEGATRON:
        from trev.model_parallel.megatron import mpu
